...
code_folder <- getwd() # must be the folder directly contains files for simulations
...
################################################################################
# Performance comparisons among fwer+, stepM and StepSPA with varying time windows.
################################################################################
b_list <- list(c(2,1,1),c(2.4,1.5,1.5),c(2.8,2,2))
# cases of b_list to run
B <- c(1,2,3)[2]
...
source('Plot - Performance comparison among fwer plus StepM and StepSPA under varying time windows.R')
...
################################################################################
# erformance of fwer+ under use of insufficient information
################################################################################
# covariate coefficient cases:
b_list <- list(c(2,1,1),c(2.4,1.5,1.5),c(2.8,2,2))
# cases of b_list to run
